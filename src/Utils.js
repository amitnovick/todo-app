...
export const uploadServerCreateTodo = (updateStateCreateTodo, inputCreateTodoValue) => {
...
export const uploadServerUpdateTodo = (updateStateUpdateTodo, inputUpdateTodoValue, itemId) => {
    const params = new URLSearchParams();
